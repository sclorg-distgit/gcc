...
This package contains documentation for GCC 8 JIT front end.

%package -n libquadmath
Summary: GCC 8 __float128 shared support library
Group: System Environment/Libraries
Requires(post): /sbin/install-info
Requires(preun): /sbin/install-info
...
Summary: GCC 8 __float128 support
Group: Development/Libraries
%if 0%{!?scl:1}
...
%package -n libasan
Summary: The Address Sanitizer runtime library from GCC 8
Group: System Environment/Libraries
Requires(post): /sbin/install-info
Requires(preun): /sbin/install-info

%description -n libasan
This package contains the Address Sanitizer library from GCC 8
...
Group: Development/Libraries
%if 0%{?rhel} > 7
Requires: libubsan >= 8.1.1
%else
Requires: libubsan1 >= 8.1.1
%endif
